...
function moveCursors() {
  ...
  normalCursor.style.transform = "translate3d(" + (cursorX - 25) + "px, " + (cursorY - 25) + "px, 0)";

  videoX = videoX + ((mouseX + 30) - videoX) * 0.12;
  videoY = videoY + ((mouseY + 30) - videoY) * 0.12;
  videoCursor.style.transform = "translate3d(" + videoX + "px, " + videoY + "px, 0)";
...
let links = document.querySelectorAll("a, button, input, textarea, select, .service-item");
...
let whatsappBtn = document.querySelector("#whatsappFloatingBtn");
let phoneNumber = "33780979269";

if (whatsappBtn) {
  whatsappBtn.href = "https://wa.me/" + phoneNumber + "?text=Hello%20Studio%20Namma";
}
